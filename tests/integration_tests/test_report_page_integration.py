...
@pytest.mark.parametrize("saas_type_id", [0, 1, 2])
...
# ])
def test_generate_report_app(saas_type_id, orientation, industry_id, annual_revenue_million, gen_recommendations):
    ...
    # clear_session_state(app) #Protects against old data in multiple runs
